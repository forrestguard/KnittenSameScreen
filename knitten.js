document.addEventListener('DOMContentLoaded', () => {
    ...
    const messageToCardMap = {
        'RL': { shape: 'L', color: 'red' },
        'BL': { shape: 'L', color: 'blue' },
        'YL': { shape: 'L', color: 'yellow' },
        'RJ': { shape: 'J', color: 'red' },
        'BJ': { shape: 'J', color: 'blue' },
        'YJ': { shape: 'J', color: 'yellow' },
        'RO': { shape: 'O', color: 'red' },
        'BO': { shape: 'O', color: 'blue' },
        'YO': { shape: 'O', color: 'yellow' },
        'RT': { shape: 'T', color: 'red' },
        'BT': { shape: 'T', color: 'blue' },
        'YT': { shape: 'T', color: 'yellow' },
        'RI': { shape: 'I', color: 'red' },
        'BI': { shape: 'I', color: 'blue' },
        'YI': { shape: 'I', color: 'yellow' },
        'RDia': { shape: 'Dia', color: 'red' },
        'BDia': { shape: 'Dia', color: 'blue' },
        'YDia': { shape: 'Dia', color: 'yellow' },
        'RS': { shape: 'S', color: 'red' },
        'BS': { shape: 'S', color: 'blue' },
        'YS': { shape: 'S', color: 'yellow' },
        'RZ': { shape: 'Z', color: 'red' },
        'BZ': { shape: 'Z', color: 'blue' },
        'YZ': { shape: 'Z', color: 'yellow' },
        'RC': { shape: 'C', color: 'red' },
        'BC': { shape: 'C', color: 'blue' },
        'YC': { shape: 'C', color: 'yellow' },
    };
